...
const ActivityRing: React.FC<{
  ...
  label: string
  metric: string
}> = ({ value, maxValue, color, label, metric }) => {
    ...
    <div className="flex flex-col items-center">
      <div className="relative w-24 h-24 flex items-center justify-center">
        ...
        <svg className="w-full h-full" viewBox="0 0 100 100">
          <circle cx="50" cy="50" r={radius} fill="none" stroke="#e6e6e6" strokeWidth={strokeWidth} />
          <circle
            cx="50"
            cy="50"
            r={radius}
...
const MetricChart: React.FC<{
  ...
  useEffect(() => {
    ...
    // Add y-axis
    svg.append("g").call(d3.axisLeft(y).ticks(5)).selectAll("text").attr("font-size", "8px")
...
export const AnalysisDashboard: React.FC<AnalysisDashboardProps> = ({ selectedWorkout, workoutHistory }) => {
  ...
  if (!selectedWorkout && (!workoutHistory || workoutHistory.length === 0)) {
    return (
      <div className="bg-white rounded-lg shadow-lg p-6 text-center">
        <h3 className="text-lg font-semibold mb-4">No Workout Data Available</h3>
        <p className="text-gray-600">Complete a workout task from your roadmap to see your analysis here.</p>
      </div>
    )
  }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Recovery Score:</span>
                <span className="text-green-500 font-medium">74%</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-3">
          <div className="flex mb-4 border-b">
            ...
            <button
              className={`px-4 py-2 text-sm font-medium ${
                activeTab === "vo2max" ? "border-b-2 border-purple-500 text-purple-600" : "text-gray-500"
              }`}
            ...
            <button
              className={`px-4 py-2 text-sm font-medium ${
                activeTab === "heartRate" ? "border-b-2 border-red-500 text-red-600" : "text-gray-500"
              }`}
            ...
            <button
              className={`px-4 py-2 text-sm font-medium ${
                activeTab === "duration" ? "border-b-2 border-green-500 text-green-600" : "text-gray-500"
              }`}
          ...
          <div className="space-y-6">
            ...
            {activeTab === "vo2max" && (
              <div>
                <h3 className="text-lg font-semibold mb-2">VO2 Max Trend</h3>
            ...
            {activeTab === "heartRate" && (
              <div>
                <h3 className="text-lg font-semibold mb-2">Heart Rate Analysis</h3>
                <p className="text-sm text-gray-600 mb-4">
